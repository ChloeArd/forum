    ...
    <div id="containerCategories" class="flexCenter flexRow wrap">
        ...
        if (isset($var['categories'])) {
            foreach ($var['categories'] as $categorie) { ?>
                <a href="../index.php?controller=categories" class="flexColumn flexCenter categories">
        ...
        if (isset($_SESSION['id'])) {
            if ($_SESSION['role_fk'] === "1") { ?>
                <a href="../index.php?controller=categories&action=new&id=<?=$_SESSION['id']?>" class="flexColumn flexCenter categories">
