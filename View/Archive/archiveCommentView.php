...
foreach ($comment as $com) { ?>
    <main>
        <h1 class="center">Archiver le commentaire de : <span class="salmon"><?=$com->getUserFk()->getPseudo()?></span></h1>
        <h2 class="center margTop40">Voulez vous vraiment archiver ce commentaire ?</h2>
        <p class="gray center margTop15">Si oui, le commentaire ne pourra plus être modifié !</p>
